...
vst_filepath = paste0(wkdir, paste(run_name, run_name_suffix, "vst_remove_low_count_samples_and_genes_n191x5894.gct", sep = "_"))
...
#Compound metadata
comp_meta = read.csv('/idi/cgtb/jbagnall/psa_RNAseq/annotation/Metadata_compound_JB_230626.csv', stringsAsFactors = F)
...
col_meta = mutate(col_meta, comb_id = strain_id)
...
data_zscore = base::pmax(data_zscore, -10)
data_zscore = base::pmin(data_zscore, 10)
